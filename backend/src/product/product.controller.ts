import { Controller, Get, Post, Put, Delete, Body, Req,Res, HttpCode, Param, UseInterceptors, UploadedFile, Query } from '@nestjs/common';
...
@Post('/create')
 ...
 @Delete('/delete')
 deleteTask(@Query('productID') productID, @Res() res){
